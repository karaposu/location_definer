...
setup(
    ...
    name='location_definer',  # Package name
    version='0.0.1',  # Version of your package
    author='Enes Kuzucu',  # Your name
    
    description='small tool to define locations with exceptions and with different granularity as city, country, region ',  # Short description
    long_description=open('README.md').read(),  # Long description from a README file
    long_description_content_type='text/markdown',  # Type of the long description
    packages=find_packages(),  # Automatically find packages in the directory
    install_requires=[ 'geonamescache' ],
